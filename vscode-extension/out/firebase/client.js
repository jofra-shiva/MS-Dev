...
function getFirebaseApp() {
    ...
    const firebaseConfig = {
        apiKey: cfg.get('firebaseApiKey', ''),
        authDomain: cfg.get('firebaseAuthDomain', ''),
        projectId: cfg.get('firebaseProjectId', ''),
        appId: cfg.get('firebaseAppId', ''),
        messagingSenderId: cfg.get('firebaseMessagingSenderId', ''),
    };
    if (!firebaseConfig.apiKey || !firebaseConfig.projectId) {
        throw new Error('MSDEV Firebase config is missing. Please set msdev.firebaseApiKey and msdev.firebaseProjectId in VS Code Settings.');
    }
