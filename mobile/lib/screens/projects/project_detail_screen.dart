                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        _buildStatCard('$totalTasks', 'Total Tasks', const Color(0xFFFBBF24)),
                        _buildStatCard('$inProgressTasks', 'In Progress', const Color(0xFFF59E0B)),
                        _buildStatCard('$completedTasks', 'Completed', const Color(0xFF10B981)),
                        _buildStatCard('${members.length}', 'Team Size', const Color(0xFF38BDF8)),
                      ],
                    ...
                    if (topRecentTasks.isEmpty)
                      Container(
                        ...
                        child: Center(child: Text('No tasks yet', style: TextStyle(color: Colors.white.withValues(alpha: 0.3)))),
                      )
                    else
                      Column(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Overall completion', style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontSize: 13, fontWeight: FontWeight.w500)),
                              Text('${pct.round()}%', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 14)),
                            ],
                          ),
                          const SizedBox(height: 16),
                          Center(child: _WaterBottleProgress(pct: pct)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (p['github']?['connected'] == true) ...[
                            ...
                            Text('${p['github']['repoOwner']}/${p['github']['repoName']}', style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontSize: 13)),
                            const SizedBox(height: 12),
                            Row(
                              children: [
                                const Icon(Icons.flash_on, color: Color(0xFFF59E0B), size: 14),
                                const SizedBox(width: 4),
                                Text('${p['stats']?['totalCommits'] ?? 0} commits tracked', style: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 12, fontWeight: FontWeight.w500)),
                              ],
                            ),
                          ] else ...[
                            Text('Not connected', style: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 13)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(label, style: TextStyle(fontSize: 11, color: Colors.white.withValues(alpha: 0.5), fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            backgroundImage: (photo != null && photo.isNotEmpty && !photo.startsWith('/'))
                ? NetworkImage(photo)
                : null,
            child: (photo == null || photo.isEmpty)
                ? Text(name.isNotEmpty ? name[0].toUpperCase() : 'U', style: GoogleFonts.raleway(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white))
                : null,
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(email, style: TextStyle(fontSize: 11, color: Colors.white.withValues(alpha: 0.5)), maxLines: 1, overflow: TextOverflow.ellipsis),
              ],
            ),
          ),
          const SizedBox(width: 12),
          Container(
            ...
            decoration: BoxDecoration(color: roleColor.withValues(alpha: 0.15), borderRadius: BorderRadius.circular(99)),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
          decoration: BoxDecoration(color: pColor.withValues(alpha: 0.15), borderRadius: BorderRadius.circular(99)),
...
class _ProjectDropdownTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (uid == null) {
      return Text(currentProjectName, style: GoogleFonts.raleway(fontWeight: FontWeight.w800, color: Colors.white, fontSize: 18));
    }
