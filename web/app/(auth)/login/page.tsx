  ...
  return (
    <div className="auth-bg">
      ...
      >
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleEmailSignIn(); }} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '24px 0', gap: 12 }}>
          ...
          <div style={{ fontSize: 12, color: 'var(--text-3)', fontWeight: 600 }}>OR</div>
          <div style={{ flex: 1, height: 1, background: 'var(--border)' }} />
        </div>
